...
export function register(config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    console.log('[sw] public url', publicUrl.origin, 'vs location', window.location.origin, 'same', publicUrl.origin === window.location.origin);
  ...
  navigator.serviceWorker
    ...
    .then((registration) => {
      ...
      registration.onupdatefound = () => {
        ...
        console.log('[sw] installing worker:', installingWorker);
        if (installingWorker == null) return;
        installingWorker.onstatechange = () => {
          console.log('[sw] state change:', installingWorker.state);
